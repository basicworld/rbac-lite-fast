...
public class ConfigConstants {
    ...
    /** 配置关键字：邮箱host */
    public static final String KEY_MAIL_HOST = "spring.mail.host";
    /** 配置关键字：邮箱from */
    public static final String KEY_MAIL_FROM = "spring.mail.from";
    /** 配置关键字：邮箱username */
    public static final String KEY_MAIL_USERNAME = "spring.mail.username";
    /** 配置关键字：邮箱password */
    public static final String KEY_MAIL_PASSWORD = "spring.mail.password";
    /** 配置关键字：邮箱port */
    public static final String KEY_MAIL_PORT = "spring.mail.port";
    /** 配置关键字：邮箱ssl-enable */
    public static final String KEY_MAIL_SSL_ENABLE = "spring.mail.properties.mail.smtp.ssl.enable";
