...
INSERT INTO `sys_configuration` VALUES (1,'用户密码过期时间（天）','my.user.password.expire_time','60','integer',1,'string',NULL,1,0000000001,'30','整数数字，用户超过这个时间未修改密码的，将通过站内信发出提醒。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:14:54'),(2,'EMAIL HOST','spring.mail.host','smtp.163.com','string',1,'string',NULL,1,0000000002,NULL,'同spring.mail.host。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:11:18'),(3,'EMAIL FROM','spring.mail.from','xxxx@163.com','string',1,'string',NULL,1,0000000003,NULL,'同spring.mail.from。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:11:18'),(4,'EMAIL USERNAME','spring.mail.username','xxxx@163.com','string',1,'string',NULL,1,0000000004,NULL,'同spring.mail.username。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:11:18'),(5,'EMAIL PASSWORD','spring.mail.password','xxxx','string',1,'password',NULL,1,0000000005,NULL,'同spring.mail.password。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:15:47'),(6,'EMAIL PORT','spring.mail.port','994','integer',1,'string',NULL,1,0000000006,NULL,'同spring.mail.port，只能是数字。','admin','2021-01-01 12:30:00','admin','2021-05-10 15:55:26'),(7,'EMAIL ENABLE SSL','spring.mail.properties.mail.smtp.ssl.enable','1','byte',1,'radio','1:启用SSL,0:不启用SSL',1,0000000007,NULL,'同spring.mail.properties.mail.smtp.ssl.enable。','admin','2021-01-01 12:30:00','admin','2021-05-10 13:04:25'),(8,'邮件发送功能','my.system.mail.open','1','byte',1,'radio','1:启用,0:不启用',1,0000000008,NULL,'选择启用以开通邮件发送功能，启用前请确认邮箱参数配置正确。','admin','2021-01-01 12:30:00','admin','2021-05-10 14:56:38');
...
INSERT INTO `sys_message` VALUES (1,'admin',NULL,'admin',1,'演示通知标题','演示通知内容。',1,1,0,NULL,'2021-01-01 11:00:00','超级管理员','2021-05-07 13:57:20'),(2,'系统提醒',0,'超级管理员',1,'密码过期预警','你已经超过 1 天未修改密码，为了账号安全请及时修改密码。',1,1,0,'系统提醒','2021-05-10 11:47:03','超级管理员','2021-05-10 11:47:14'),(3,'系统提醒',0,'超级管理员',1,'密码过期预警','你已经超过 1 天未修改密码，为了账号安全请及时修改密码。',1,1,0,'系统提醒','2021-05-10 11:47:25','超级管理员','2021-05-10 11:48:02');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='role table of system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='role menu connection';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_menu` VALUES (1,1,1),(2,1,2),(3,1,3);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='system user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,'admin','$2a$10$TT0JVZkVlCnrEP1rt5nnye6YRleNihqx0r1dbR1J2Up/j77Ikxyua',0,'超级管理员','','','2021-05-07 16:09:10',NULL,NULL,'2021-03-27 18:34:41',NULL,'2021-05-07 16:09:10',0,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='user role connection';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-10 15:59:59
